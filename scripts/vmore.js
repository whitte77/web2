...
function changeLanguage(language) {
  ...
  const baseUrl = language === 'ptbr' ? '../pages/vmore-ptbr.html' : '../pages/vmore.html';

  window.location.href = `${baseUrl}?${productId}`;
  console.log(`deu bom?: ${baseUrl}?${productId}`)
}

//Eu mudei o nome das páginas, blz?

// funcionou
// o href que estava junto no html deu conflito, ele tava recarregando
// a pagina antes da funçao em si rodar, ai agora parece que foi
// só colocar no vmore-ptbr agr
//coloquei